...
const Record_row = (props) => {
    ...
    const delete_movie=(id)=>{
        // console.log(id)
        axios.delete('api/movie/delete/',{data:{id}})
        .then(res=>{
            // console.log(res);
    ...
    return (
        <tbody>
            <tr>
                 ...
                 <td>
                    <Link to={'/admin/movies/edit/'+props.movie._id}  className="btn btn-out waves-effect waves-light btn-success btn-square">edit</Link>
             ...
             <tr>
                 ...
                 <td>
                    <a href="#" onClick={(e)=>{e.preventDefault();delete_movie(props.movie._id)}} className="btn btn-out waves-effect waves-light btn-danger  btn-square">Yes</a>
